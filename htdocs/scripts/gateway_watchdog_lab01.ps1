...
# Gateway lab01 (porta 4010, sessão crm-sandbox)
$InstanceSlug = 'lab01'
...
$StartCommand = Join-Path $RepoRoot 'services/whatsapp-web-gateway/start-gateway.bat'
$LogPath = Join-Path $RepoRoot 'storage/logs/gateway_watchdog_lab01.log'
$StatePath = Join-Path $RepoRoot 'storage/logs/gateway_watchdog_lab01.state.json'
